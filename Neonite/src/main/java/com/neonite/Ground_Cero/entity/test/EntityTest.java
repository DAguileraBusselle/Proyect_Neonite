package com.neonite.Ground_Cero.entity.test;



import com.neonite.Ground_Cero.util.handlers.LootTableHandler;
import com.neonite.Ground_Cero.util.handlers.SoundsHandler;
...
public class EntityTest extends EntityAgeable
{
	...
	protected void initEntityAI() 
	{
		...
		this.tasks.addTask(3, new EntityAIAvoidEntity<EntityMob>(this, EntityMob.class, 4.0F, 2.2D, 2.2D));
